...
describe('Admin Provider Requests API', () => {
  ...
  describe('GET /api/admin/provider-requests', () => {
    it('returns 403 for non-staff user (isRefyneStaff = false)', async () => {
    ...
    it('returns 403 for user with missing metadata', async () => {
      mockGetUser.mockResolvedValue({
        publicMetadata: {},
      });
    ...
    it('returns all requests for staff user (isRefyneStaff = true)', async () => {
      mockGetUser.mockResolvedValue({
        publicMetadata: {
          isRefyneStaff: true,
        },
    ...
    it('returns 403 when Clerk API call fails', async () => {
  ...
  describe('PATCH /api/admin/provider-requests/[id]', () => {
    ...
    it('updates status successfully for staff user (isRefyneStaff = true)', async () => {
      mockGetUser.mockResolvedValue({
        publicMetadata: {
          isRefyneStaff: true,
        },
