...
export default function NewPostPage() {
  ...
  }, [postId, title, excerpt, bodyJson, bodyHtml, tag, coverImageUrl, coverImageAlt, seoTitle, seoDescription, featured]);
  ...
  const publishPost = async () => {
    if (!postId) {
      await createDraft();
      // Wait a bit for postId to be set
