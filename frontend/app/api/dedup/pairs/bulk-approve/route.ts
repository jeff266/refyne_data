...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (selectError) {
      captureWithOrgContext(selectError, ctx.orgId, { route: '/api/dedup/pairs/bulk-approve' });
    ...
    if (updateError) {
      captureWithOrgContext(updateError, ctx.orgId, { route: '/api/dedup/pairs/bulk-approve' });
    ...
    captureWithOrgContext(error, ctx.orgId, { route: '/api/dedup/pairs/bulk-approve' });
