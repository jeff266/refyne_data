...
import type { PairGrade, PairStatus } from '@/lib/dedup/types';
 ...
 *
 * Returns list of contact dedup pairs with filtering and pagination.
 */
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      captureWithOrgContext(error, ctx.orgId, { route: '/api/contact-dedup/pairs' });
      console.error('Failed to get contact dedup pairs:', error);
      return NextResponse.json(
